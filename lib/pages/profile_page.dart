          ...
          Row(
            children: [
              ...
              Avatar(
                ...
                name: 'Undefyned', // Fallback if no image source is available
              ),
  ...
  void _handleImageSelection(BuildContext context) async {
    ...
    if (result != null) {
      ...
      var response = await http.post(
        Uri.parse('http://10.0.2.2:3000/post'),
        headers: {
      ...
      if (response.statusCode == 201) {
        ...
        var gas = int.parse(jsonResponse['gas']);
        ...
        var provider = EthereumWalletConnectProvider(globals.connector);
        var hash = await provider.sendTransaction(
          from: from,
          to: to,
          data: data,
          gas: gas,
